...
while (true) {
    const opcion = Number(prompt('Menú de Ejercicios:\n' +
    ...
    if (opcion === 0) {
        ...
        for (const ejercicio in ejecuciones) {
            console.log(`Ejercicio ${ejercicio}: ${ejecuciones[ejercicio]} veces`);
        }
    ...
    if (opcion >= 1 && opcion <= 10) {
        if (!ejecuciones[opcion]) {
            ejecuciones[opcion] = 0;
        }
        ...
        const respuesta = prompt("¿Desea ejecutar este ejercicio? (Sí/No): ");

        if (respuesta.toLowerCase() === "si" || respuesta.toLowerCase() === "sí") {
            ejecuciones[opcion]++;
            console.log(`Ejecutando ejercicio ${opcion}...`);
            console.log(`Ejercicio ${opcion} resuelto.`);
        } else {
            console.log("Ejercicio no ejecutado.");
        }
    } else {
